...
## Project Structure
    ...
    ├── testapiautocatalog_115441  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_115441`
...
2. Clone this repo and `cd testapiautocatalog_115441`
